...
@media(max-width:540px){.cards{grid-template-columns:1fr 1fr}.card b{font-size:22px}th:nth-child(n+4),td:nth-child(n+4){display:none}}
</style>
</head>
<body>
...
export function registerConsoleRoutes({ app }) {
  ...
  app.get('/console/app.js', (_req, res) => {
    res.type('application/javascript').send(`(${runAureonConsole.toString()})();`);
  });
}
